# REGLAS MANDATORIAS Y OBLIGATORIAS DEL PROYECTO (GEMINI.MD)

> **ATENCIÓN A GEMINI / GOOGLE ANTIGRAVITY**: Este proyecto está regido por un conjunto de **Reglas Mandatorias e Inviolables** ubicadas en `.agents/rules/` y **Habilidades Específicas** en `.agents/skills/`.
